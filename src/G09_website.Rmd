...
```{r}
fps <- list.files("/Users/sharon/Desktop/science_data/Politics_txt_by_years", full.names = T)
...
```{r}
#在外部構造一個jieba分詞器 
seg <- worker(user = "/Users/sharon/Desktop/science_data/user_dict.txt", stop_word = "/Users/sharon/Desktop/science_data//stop_word.txt")
